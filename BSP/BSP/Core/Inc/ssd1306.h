...
#define __SSD1306_H__
  ...
  #define SSD1306_DISPLAY_CLOCK_DIV 0xD4
  ...
  #define SSD1106_PAGE_SELECT       0xB0
...
// -------------------------------------------
  ...
  /**
    ...
    */
   uint8_t TWI_MT_Send_SLAW(uint8_t);
    ...
    * @return  uint8_t
    */
   uint8_t TWI_MT_Send_Data(uint8_t);
    ...
    * @return  unsigned uint8_t
    */
   uint8_t TWI_MR_Send_SLAR(uint8_t);
